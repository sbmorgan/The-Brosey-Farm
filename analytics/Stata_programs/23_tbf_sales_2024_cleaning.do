...
*************************************************************************************************
***                                                                                           ***
*** Program name: 23_tbf_sales_2024_cleaning.do                                               ***
*** Project: TBF Market Garden 2024                                 				          ***
*** Purpose: Clean TBF Market Garden 2024 sales data                                          ***    
***																	 				          ***
*** Contents:                                                       				          ***
***    0) SET UP CODE                              				                              ***
***    I) LOAD RAW DATA                                                                       ***
...
*=========================================================================================
	...
	/* Load raw data */
	import excel "$root\raw_data\Brosey Farming.xlsx", sheet("sales_2024") firstrow clear
	keep sale_date-sale_value_usd
	ds 
	
	/* Save raw TBF Market Garden 2023 data */
	save "$root\raw_data\tbf_market_garden_sales_2024_raw.dta", replace
	export excel "$root\raw_data\tbf_market_garden_sales_2024_raw.xlsx", firstrow(variables) replace
