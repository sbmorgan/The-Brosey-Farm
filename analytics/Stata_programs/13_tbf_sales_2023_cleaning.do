...
log using "C:\Users\sethb\Documents\The Brosey Farm\GitHub repositories\The-Brosey-Farm\analytics\Stata_programs\13_tbf_sales_2023_cleaning.log", replace name(cleaning_13)
...
*=========================================================================================
	...
	export excel "$root\raw_data\tbf_market_garden_sales_2023_raw.xlsx", firstrow(variables) replace
